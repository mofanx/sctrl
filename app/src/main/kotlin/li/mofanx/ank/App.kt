...
import li.mofanx.ank.notif.initChannel
import li.mofanx.ank.shizuku.initShizuku
import li.mofanx.ank.store.initStore
import li.mofanx.ank.util.AndroidTarget
import li.mofanx.ank.util.LogUtils
import li.mofanx.ank.util.PKG_FLAGS
import li.mofanx.ank.util.deviceInfoDesc
import li.mofanx.ank.util.initAppState
import li.mofanx.ank.util.initToast
...
data class AppMeta(
    ...
    val commitUrl = "https://github.com/mofanx/ank/".run {
