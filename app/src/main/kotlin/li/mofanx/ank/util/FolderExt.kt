...
import li.mofanx.ank.data.UserInfo
import li.mofanx.ank.data.otherUserMapFlow
import li.mofanx.ank.permission.allPermissionStates
import li.mofanx.ank.shizuku.currentUserId
...
private val filesDir: File by lazy {
    val markFile = app.filesDir.resolve(".ank")
    if (markFile.isFile) {
        app.filesDir
    } else {
        // fix #1333
...
fun buildLogFile(): File {
    ...
    tempDir.resolve("ank-${META.versionCode}-v${META.versionName}.json").also {
