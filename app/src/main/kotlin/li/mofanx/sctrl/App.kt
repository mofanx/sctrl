...
import li.mofanx.sctrl.notif.initChannel
import li.mofanx.sctrl.shizuku.initShizuku
import li.mofanx.sctrl.store.initStore
import li.mofanx.sctrl.util.AndroidTarget
import li.mofanx.sctrl.util.LogUtils
import li.mofanx.sctrl.util.PKG_FLAGS
import li.mofanx.sctrl.util.deviceInfoDesc
import li.mofanx.sctrl.util.initAppState
import li.mofanx.sctrl.util.initToast
...
data class AppMeta(
    ...
    val commitUrl = "https://github.com/mofanx/sctrl/".run {
